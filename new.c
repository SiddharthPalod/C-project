...
struct restaurant restaurants[20] = {{"Burger King", "Bg rd", NULL}, {"ChaiPoint", "rd", NULL}, {{"KFC", "Bg Road", NULL}, {"MCD", "Bg Road", NULL}, {"KVR", "Mg Road", NULL}, {"\0", "", NULL}};// has a list of all restaurants with a '\0' terminating it
